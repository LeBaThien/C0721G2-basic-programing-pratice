...
public class EmployeeToCsv {
    public static File file = new File("D:\\codegym_final\\case_study2\\src\\case_study\\data\\employee.csv");
...
//            }
    ...
    public static void writeListEmployeeToCSV (List<Employee> employees){
        try{
