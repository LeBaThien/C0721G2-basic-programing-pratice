...
//    }
    ...
    private void findUserByCountry(HttpServletRequest request, HttpServletResponse response)
        ...
        List<User> listUser = userDAO.findUserByCountry(request.getParameter("country"));
...
//        dispatcher.forward(request, response);
//    }
    private void showUserBySP(HttpServletRequest request, HttpServletResponse response)
            throws SQLException, IOException, ServletException {
        List<User> listUser = userDAO.selectAllUsers();
        request.setAttribute("listUser", listUser);
        RequestDispatcher dispatcher = request.getRequestDispatcher("user/list.jsp");
